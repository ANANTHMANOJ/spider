	...
	<div class="container">
				<div class="row">
					<div class="col-md-8">
						...
						<form class="form-light mt-20" role="form" action="contactus_mail.php" method="POST" >
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Email</label>
										<input type="email" class="form-control" name="senderemail"placeholder="Email address">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="form-group">
								<label>Subject</label>
								<input type="text" name="sendersubject" class="form-control" placeholder="Subject">
							</div>
							<div class="form-group">
								<label>Message</label>
								<textarea class="form-control" name="message" placeholder="Write you message here..." style="height:100px;"></textarea>
							</div>
							...
							if(isset($_POST['submit']))
							{
								...
								{
   								   echo "<script>
								   alert('Sorry!! Could not send your mail!!Please retry');
								   </script>";
